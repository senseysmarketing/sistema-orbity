...
export function CustomStatusManager({ onStatusUpdate }: CustomStatusManagerProps) {
  ...
  const defaultStatuses = [
    { id: 'default-1', name: "Novo", color: "bg-blue-500", is_default: true, is_system: true, order_position: 0 },
    { id: 'default-2', name: "Qualificado", color: "bg-orange-500", is_default: true, is_system: true, order_position: 1 },
    { id: 'default-3', name: "Ganho", color: "bg-green-500", is_default: true, is_system: true, order_position: 2 },
    { id: 'default-4', name: "Perdido", color: "bg-red-500", is_default: true, is_system: true, order_position: 3 },
  ];
