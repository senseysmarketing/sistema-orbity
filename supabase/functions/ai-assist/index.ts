    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          suggested_type: { type: "string", description: "Sugestão de tipo baseado no contexto. Se o usuário descrever conteúdo para redes sociais (post, reels, stories, carrossel, etc.), use 'redes_sociais'. Se descrever arte, banner, criativo, material visual, peça gráfica, use 'criativos'. Se o usuário descrever tráfego pago, campanhas de anúncios, Google Ads, Meta Ads, Facebook Ads, otimização de campanhas, gestão de mídia paga, análise de métricas de ads, orçamento de campanhas, use 'trafego'. Outros exemplos: desenvolvimento, suporte, administrativo, reuniao." },
